...
class Presenteruploads extends React.Component{
    state={
        username:'',
        email:'',
        phoneNumber:'',
                                        ...
                                        <div className="col-lg-6">
                                            <div className="signup-left-area">
                                                ...
                                                <div className="sign-up-form-area">
                                                    <form className="signup-form" encType='multipart/form-data' onSubmit={this.formSubmit}>
                                                        <div className="row">
...
export default Presenteruploads;